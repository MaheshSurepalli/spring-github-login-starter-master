...
public class SearchController {
    ...
    public SearchController(WebClient.Builder webClientBuilder){
        this.webClient=webClientBuilder.exchangeStrategies(ExchangeStrategies.builder().codecs(configurer->configurer.defaultCodecs().maxInMemorySize(16*1024*1024)).build())
       ...
       Mono<SearchResult> resultsMono= this.webClient.get()
        ...
        .map(bookResult->{
            ...
            if(StringUtils.hasText(coverId)){
                coverId = URL_PREFIX+coverId+"-M.jpg";
            }
            else
                coverId="/images/noimg.jpg";
